...
\begin{align*}
\beta 
&= P\bigg(\frac{(\hat{p}_{1}-\hat{p}_{2})-d_{0}}{ \sqrt{ \frac{\tilde{p}_{1}(1-\tilde{p}_{1})}{n_{1}} + \frac{\tilde{p}_{2}(1-\tilde{p}_{2})}{n_{2}}}} \leq z_{\alpha} \bigg\vert \, p_{1} - p_{2} = d_{1} \bigg) \\
