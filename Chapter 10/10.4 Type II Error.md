...
&= P \Bigg( 
    \underbrace{\frac{{TS-\frac{p_{1}-p_{0}}{\sqrt{\frac{p_{0}(1-p_{0})}{n}}}}}{\sqrt{\frac{p_{1}(1-p_{1})}{p_{0}(1-p_{0})}}}}_{\mathcal{N}(0,1)} \leq
    \frac{z_{\frac{\alpha}{2}} - \frac{p_{1}- p_{0}}{\sqrt{ \frac{p_{0}(1-p_{0})}{n} }}}{\sqrt{\frac{p_{1}(1-p_{1})}{p_{0}(1-p_{0})}}}\Bigg)
    -\Bigg(\underbrace{\frac{ {TS - \frac{p_{1}- p_{0}}{\sqrt{ \frac{p_{0}(1-p_{0})}{n} }}}}{\sqrt{\frac{p_{1}(1-p_{1})}{p_{0}(1-p_{0})}}}}_{\mathcal{N}(0,1)}\leq
